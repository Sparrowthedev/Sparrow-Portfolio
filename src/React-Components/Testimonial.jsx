        ...
        <SecondRow className="row">
          {Testimonials.map((item, index) => {
            const isSingleLetter =
              item.img.length === 1 && /[A-Za-z]/.test(item.img);

            return (
              <SecondCol className="col-lg-6 align-items-center justify-content-center">
                <Fade>
                  <Card>
                    <Top>
                      <ImageDiv>
                        {isSingleLetter ? (
                          <LetterDiv>
                            <h1
                              style={{ fontWeight: "bold", color: "#08ea6d", margin: "0 auto",}}
                            >
                              {item.img}
                            </h1>
                          </LetterDiv>
